...
public class EmployeesArray {
	...
	public static void main(String[] args) {
		...
		/*
		 * 
		 * Philipa-Salthouse Electrical Engineer Ulrika-Goolding Nuclear Power Engineer
		 * ... Dinnie Ehlerding [Librarian] dehlerding24@naver.com
		 */
		...
		/*
		 * Tracy Bartle should be Geological Engineer Skipper Abrahamsson should be
		 * Financial Advisor if true{ Print "PASS: Verification successful. Tracy
		 * Bartle's job is Geological Engineer }else{ Print "FAIL: Verification error:
		 * Tracy Bartle's job is NOT Geological Engineer }
		 */
